...
export const environment = {
 ...
 /* prourl: 'http://localhost/inventario/provedor.php/provedor',
  ...
  prourl: 'http://inventario-tecsoni.com.co/inventario/provedor.php/provedor',
  ciurl: 'http://inventario-tecsoni.com.co/inventario/ciudad.php/ciudad',
  equiurl: 'http://inventario-tecsoni.com.co/inventario/equipo.php/equipo',
  marca: 'http://inventario-tecsoni.com.co/inventario/marca.php/marca',
  sedeurl: 'http://inventario-tecsoni.com.co/inventario/sede.php/sede',
  ubiurl: 'http://inventario-tecsoni.com.co/inventario/ubicacion.php/ubicacion',
  mante: 'http://inventario-tecsoni.com.co/inventario/mantenimientos.php',
  potsmanh: 'http://inventario-tecsoni.com.co/inventario/hismantenimiento.php',
  consulta: 'http://inventario-tecsoni.com.co/inventario/consultas.php',
